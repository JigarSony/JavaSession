...
public class A2FunctionInJava {

	//function and methods both are same things
	//main method -- starting point of execution
	public static void main(String[] args) {
		// new A2FunctionInJava(); -- object : object is created without name
		
		A2FunctionInJava a = new A2FunctionInJava();
		//a is object name/object reference name  
		//new A2FunctionInJava(); -- object
